  ...
  return (
    ...
    >
      <div className="grid gap-8">
        <div className="mx-auto w-full max-w-3xl rounded-2xl border border-[#f0e6db] bg-white p-5 shadow-[0_12px_28px_rgba(255,102,0,0.05)]">
        ...
        <div className="mx-auto flex w-full max-w-3xl flex-wrap items-center justify-center gap-2 text-xs text-[#7d7972]">
          <Link href="/health-records" className="rounded-full border border-[#f0e6db] bg-white px-3 py-1.5">
            Secure records
          </Link>
          <Link href="/consultations" className="rounded-full border border-[#f0e6db] bg-white px-3 py-1.5">
            See a doctor
          </Link>
        ...
        <section className="mx-auto mt-3 grid w-full max-w-5xl gap-4 md:grid-cols-3">
          <article className="rounded-2xl border border-[#f0e6db] bg-white p-5">
            <p className="text-sm font-semibold text-[#2c2925]">Your data stays yours</p>
            <p className="mt-2 text-sm text-[#7f7a73]">End-to-end encryption, strict access controls, and zero data selling.</p>
          </article>
          <article className="rounded-2xl border border-[#f0e6db] bg-white p-5">
            <p className="text-sm font-semibold text-[#2c2925]">Care that never clocks out</p>
            <p className="mt-2 text-sm text-[#7f7a73]">Get answers at 2 AM or 2 PM. A real doctor is just a tap away.</p>
          </article>
          <article className="rounded-2xl border border-[#f0e6db] bg-white p-5">
            <p className="text-sm font-semibold text-[#2c2925]">Clinically grounded</p>
            <p className="mt-2 text-sm text-[#7f7a73]">Every response is built on peer-reviewed guidelines and physician review.</p>
          </article>
        </section>
        ...
        <section className="mx-auto w-full max-w-5xl rounded-3xl bg-[#1f1b19] p-8 text-white md:flex md:items-center md:justify-between">
          ...
          <Link href="/consultations" className="mt-5 inline-flex rounded-xl bg-[#FF6600] px-5 py-3 text-sm font-semibold text-white hover:bg-[#E55C00] transition-colors md:mt-0">
            Book a Visit
          </Link>
        </section>
      </div>

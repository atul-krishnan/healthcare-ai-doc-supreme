  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-10 md:py-14">
      <div className="mb-6 max-w-3xl">
        <h1 className="font-serif text-[2.2rem] leading-tight text-[#1D3557] md:text-[3rem]">YourDoc Intake</h1>
        <p className="mt-2 text-sm text-[#62778e] md:text-base">
          Tell us what is happening. We will suggest the right care setting (self-care, OPD, urgent clinic, or ER) and
          generate a clean brief you can share.
        </p>
      </div>

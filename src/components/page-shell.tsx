...
export function PageShell({
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 py-12 md:py-16 md:px-6">
      <div className="rounded-[2rem] border border-stone-200/80 bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            {secondaryCta ? (
              <Link
                ...
                className="rounded-full border border-stone-200 px-5 py-2.5 text-sm font-medium text-stone-700 transition-colors hover:border-[#7DB8D4] hover:text-[#5A9AB8]"
              >
                {secondaryCta.label}
              </Link>
            ) : null}
